...
const promptTreeSha256 = createHash("sha256")
  .update(JSON.stringify(treeRows))
  .digest("hex");
const manifest = {
...
writeFileSync(
  resolve(args.get("out") ?? "../registry/prompt_checks/agent_prompt_role_contract_manifest_v2.json"),
