...
> = {
  semiconductor: contract(
    "semiconductor",
    {
      zh: "比较芯片设计、晶圆制造/封测、半导体设备/材料和分立器件。",
      en: "Compare chip design, wafer manufacturing/packaging, semiconductor equipment/materials, and discrete devices.",
    },
    {
      zh: ["不得纳入其他电子、计算机或通信"],
  ...
  biotech: contract(
    "biotech",
    {
      zh: "比较化学制药、中药、生物制品、医药商业、医疗器械和医疗服务。",
      en: "Compare chemical pharmaceuticals, traditional Chinese medicine, biological products, pharmaceutical commerce, medical devices, and medical services.",
    },
    {
      zh: ["不得以单一临床事件代表全行业"],
...
export const SECTOR_CONTRACT_VERSION = "sector_direction_selection_v3";
