...
export const US_ECONOMY_FIELD_NAMES = COMPONENT_MACRO_SUBMISSION_FIELD_NAMES;
export const EU_ECONOMY_FIELD_NAMES = COMPONENT_MACRO_SUBMISSION_FIELD_NAMES;
export const CENTRAL_BANK_FIELD_NAMES = COMPONENT_MACRO_SUBMISSION_FIELD_NAMES;
