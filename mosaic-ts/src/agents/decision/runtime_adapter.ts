...
function runtimeEnvelope(submission: DecisionAgentSubmission) {
  return {
    ...
    ...(submission.declared_knob_influence_ids
      ? { declared_knob_influence_ids: submission.declared_knob_influence_ids }
      : {}),
    ...(submission.declared_influence_rationale
      ? { declared_influence_rationale: submission.declared_influence_rationale }
      : {}),
