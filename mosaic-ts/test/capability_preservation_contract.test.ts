...
describe("capability preservation and KNOT contracts", () => {
  it("loads the exact current 26-stage/207-binding Gate-D release authority", () => {
    ...
    expect(authority.binding_count).toBe(207);
  ...
  it("binds trusted counterevidence coverage to the current v2 audit track", () => {
    ...
    expect(coverage.coverage).toHaveLength(207);
