    ...
    for slot in plan["slots"]:
        ...
        for accepted_kind in accepted_kinds:
            ...
            if accepted_kind == "MACRO_TRANSMISSION" and runtime_input is not None:
                ...
                payload = {
                    "agent_id": agent_id,
                    "agent_contract_version": binding["agent_behavior_bindings"][
                        agent_id
                    ]["agent_contract_version"],
                    "prompt_behavior_version": binding["agent_behavior_bindings"][
                        agent_id
                    ]["prompt_behavior_version"],
                    "execution_behavior_version": binding[
                        "agent_behavior_bindings"
                    ][agent_id]["execution_behavior_version"],
                    ...
                    "claims": [{"claim_id": f"claim-{agent_id}"}],
                    "claim_refs": [f"claim-{agent_id}"],
                    "key_drivers": ["fixture"],
                }
                composition_body = {
