...
def test_prompt_asset_validation_rejects_forbidden_mutation_target(tmp_path: Path):
    ...
    mutation_path = tmp_path / "registry/mutation_patches/central_bank_parameter_update.json"
    ...
    mutation_record = next(record for record in report.records if record.check_id == "PROMPT-MUTATION-GATE")
