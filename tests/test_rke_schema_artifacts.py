...
REQUIRED_SCHEMA_FILES = {
    ...
    "tool_environment_manifest_v1.schema.json",
    "knot_tool_coverage_manifest_v1.schema.json",
    "knot_tool_coverage_manifest_v2.schema.json",
    "knot_audit_capability_track_v2.schema.json",
    "knot_capability_use_aggregate_v1.schema.json",
    "sector_universe_manifest_v1.schema.json",
    "runtime_route_not_required_v1.schema.json",
    "agent_outcome_contract_manifest_v2.schema.json",
    "execution_behavior_release_manifest_v3.schema.json",
    "execution_behavior_release_manifest_v4.schema.json",
    ...
    "evidence_claim_graph_v2.schema.json",
    "active_prompt_release_manifest_v1.schema.json",
    "active_prompt_release_manifest_v2.schema.json",
    "active_prompt_release_manifest_v3.schema.json",
    "active_prompt_release_manifest_v4.schema.json",
    "capability_full_bundle_v1.schema.json",
    "prompt_training_projection_v2.schema.json",
    "route_eligibility_receipt_v1.schema.json",
    "agent_cycle_event_v1.schema.json",
    "agent_cycle_publication_v1.schema.json",
        ...
        json.dumps(
            {
                ...
                "layer": "macro",
                "cohort_scope": "*",
                "prompt_version": "0.4.0-private-knot",
                "role_contract": {
                ...
                "shared_contract_refs": ["knot_runtime_contract_ref_v2"],
                "status": {
