    ...
    return RouteCoverageReceipt.seal(
        {
            ...
            "required_route_ids": sorted(ECO_CAL_LOGICAL_ROUTES),
            "route_results": results,
...
def _uniform_failure(
    *,
    ...
    return _failed_result(
        ...
        ledger=ledger,
        route_statuses={
            route_id: route_status for route_id in ECO_CAL_LOGICAL_ROUTES
        },
        blockers=[blocker],
    )
...
def _rejected_batch_result(
    *,
    ...
    statuses = {
        route_id: "CAPTURE_REJECTED" for route_id in ECO_CAL_LOGICAL_ROUTES
    }
    ...
    return SourceCaptureReceipt.seal(
        {
            ...
            "pit": {
                ...
                "as_of_cutoff": _cutoff(as_of_date).isoformat(),
                "eligible": True,
                "blocker_codes": [],
                "vintage_query": None,
            },
...
def archive_eco_calendar(
    ...
    *,
    ...
    """Capture all registered eco_cal leaves and seal three logical route receipts.
    ...
    if len(audits) != len(ECO_CAL_REGISTERED_CURRENCIES):
        return _uniform_failure(
            as_of_date=as_of_date,
            ledger=ledger,
            route_status="SCHEMA_DRIFT",
