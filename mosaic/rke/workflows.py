...
def run_full_rke_refresh(
    ...
    *,
    ...
    recipe_paper_trading = write_report_intelligence_recipe_paper_trading_artifacts(
        root_path / "registry/report_intelligence",
    ...
    outputs["report_intelligence_recipe_paper_trading_runs"] = recipe_paper_trading[
        "recipe_paper_trading_runs"
    ]
    outputs["report_intelligence_recipe_paper_trading_summary"] = recipe_paper_trading[
        "recipe_paper_trading_summary"
    ]
    outputs["report_intelligence_confidence_impact_observations"] = (
        recipe_paper_trading["confidence_impact_observations"]
    )
