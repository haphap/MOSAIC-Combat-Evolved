...
- Gold-set batch: `registry/review_batches/gold_set_reviewed.jsonl`; exists: true; rows: 26; complete: 0; pending: 26; malformed: 0
  ...
  Review next fields: manual_required: `manual_claim_text`=26, `target_correct`=9, `unsupported_field_false_grounded`=5, `direction_correct`=2, `horizon_correct`=2; draft_available: `claim_correct`=26, `source_span_supports_claim`=26, `variable_mapping_correct`=26, `direction_correct`=24, `horizon_correct`=24, `unsupported_field_false_grounded`=21, `target_correct`=17
  Review workflow groups: decision: `target_correct`=9, `unsupported_field_false_grounded`=5, `direction_correct`=2, `horizon_correct`=2; metadata: none; text: `manual_claim_text`=26; draft_verify: `target_correct`=17, `unsupported_field_false_grounded`=21, `direction_correct`=24, `horizon_correct`=24, `claim_correct`=26, `source_span_supports_claim`=26, `variable_mapping_correct`=26
