...
constrained long/short-or-avoid picks, drivers, risks, claims/evidence, all ten
required Macro submission summaries, and any applicable target-level Macro
...
directional prior. The public tree contains only 56 bilingual `cohort_default`
