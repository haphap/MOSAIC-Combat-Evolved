...
Its private evidence draft is aligned with the same 20 scratch rows. The
promotion gold-set import remains not ready
because document coverage and quality-metric blockers still require pipeline
improvements and refreshed review evidence. The previous stale
