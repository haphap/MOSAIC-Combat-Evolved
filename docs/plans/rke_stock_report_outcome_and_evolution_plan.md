...
```bash
uv run python -m pytest tests/test_rke_report_intelligence.py -q --basetemp ~/tmp/mosaic-rke/pytest-rke-ri
...
```bash
uv run python -m pytest tests/test_rke_report_intelligence.py -q --basetemp ~/tmp/mosaic-rke/pytest-rke-ri
uv run python -m pytest tests/test_rke_schema_artifacts.py -q --basetemp ~/tmp/mosaic-rke/pytest-rke-schema
uvx ruff@0.15.15 check mosaic tests
git diff --check
```
