...
当前分支已按本计划落地 P6-P9，保持 gated rollout：
...
P9 unified Darwinian weights:
  ...
  默认 darwinian.weight_rewrite_enabled=false，旧 rolling Sharpe -> weight 行为保持。
  打开 flag 后使用 top quartile *1.05 / bottom quartile *0.95 / middle unchanged。
