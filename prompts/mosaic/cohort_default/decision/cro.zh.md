...
输出字段包括：`review_disposition`, `candidate_actions`, `correlated_risks`, `black_swan_scenarios`, `confidence`, `claims`, `claim_refs`, `macro_input_attributions`。

必需 runtime tools：`get_cro_risk_snapshot`, `get_role_event_snapshot`。
