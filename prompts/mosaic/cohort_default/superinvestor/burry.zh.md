...
本 agent 的 domain knob card ids：`valuation_mispricing_threshold`, `distress_catalyst_weight`, `downside_protection_min`, `short_signal_window_days`, `crowding_penalty`。
