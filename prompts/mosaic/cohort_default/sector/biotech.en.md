...
Goal: Compare investable directions within healthcare and biotech.
Cohort lens:
...
Tool: call only get_sector_research_snapshot; the runtime freezes date, directions, and candidate domain.
...
Required runtime tools: `get_sector_research_snapshot`.
