...
Current facts must come from get_euro_area_financial_conditions_snapshot; use only as-of-visible data.
...
Required runtime tools: `get_euro_area_financial_conditions_snapshot`, `get_rke_research_context`.
