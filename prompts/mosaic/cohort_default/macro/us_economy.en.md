...
# us_economy — Layer-1 macro transmission

## Runtime role and tool contract (generated from code)
Assess how the US growth, employment, inflation, and demand cycle transmits to A-shares.

Prohibited:
- Do not infer Fed policy
- Do not judge the dollar or yield curve

Only call: get_us_macro_snapshot.
...
Domain knob card ids for this agent: `growth_weight`, `employment_weight`, `inflation_weight`, `demand_weight`, `surprise_window_days`, `a_share_external_demand_weight`.
