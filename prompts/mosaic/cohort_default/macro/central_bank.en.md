...
Current facts must come from get_central_bank_snapshot; use only as-of-visible data.
...
Required runtime tools: `get_central_bank_snapshot`, `get_rke_research_context`.
