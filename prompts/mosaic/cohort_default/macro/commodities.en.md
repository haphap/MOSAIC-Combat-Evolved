...
Current facts must come from get_commodity_conditions_snapshot; use only as-of-visible data.
...
Required runtime tools: `get_commodity_conditions_snapshot`, `get_rke_research_context`.
