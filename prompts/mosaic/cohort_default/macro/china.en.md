...
Current facts must come from get_china_macro_snapshot; use only as-of-visible data.
...
Required runtime tools: `get_china_macro_snapshot`, `get_rke_research_context`.
