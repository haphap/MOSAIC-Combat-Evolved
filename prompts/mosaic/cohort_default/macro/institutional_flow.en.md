...
Current facts must come from get_market_positioning_snapshot; use only as-of-visible data.
...
Required runtime tools: `get_market_positioning_snapshot`, `get_rke_research_context`.
